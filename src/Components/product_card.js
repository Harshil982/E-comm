            ...
            <div className="Products-container">
                <Grid container spacing={10}>
                    ...
                    <Grid className="Product-info-card" item xs={10} sm={5} md={6} lg={4}>
                        ...
                        <p>All organic Ingrediants</p>
                        <p>$24.99 </p>
                        <button className="add-to-cart" value="Cream4" onClick={handleAddToCart}><FontAwesomeIcon icon={faCartPlus} /><span className="cart-text" value="Cream4">Add to Cart</span></button>
                    </Grid>
                </Grid>
            </div>
        </>
